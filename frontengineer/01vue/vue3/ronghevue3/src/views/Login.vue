        ...
        <div class="login-form-container">
          ...
          <el-form :model="account" :rules="rules" ref="userFormInst" class="login-form" @keydown.enter="login">
            ...
            <el-form-item prop="allow" >
                ...
                class="allow-warp"
                v-model="isAllow">
                    我已阅读并同意<a href="#" class="link">《隐私政策》</a><a href="#" class="link">《服务条款》</a>
                </el-checkbox>
            </el-form-item>
...
<script setup>
import { DataAnalysis, Key, Lock, User, Tools, Setting} from '@element-plus/icons-vue'
...
const projectName = ref('融合管理平台')
const router = useRouter()
const userFormInst = ref()
...
.background-shapes{
  ...
  .shape{
    ...
    &-2{
      width: 200px;
      height: 200px;
      background: linear-gradient(45deg, rgba(126, 87, 194, 0.1) 0%, 
    ...
    &-3{
      width: 150px;
      height: 150px;
      background: linear-gradient(45deg, rgba(66, 165, 245, 0.1) 0%, 
    ...
    &-4{
      width: 250px;
      height: 250px;
      background: linear-gradient(45deg, rgba(239, 83, 80, 0.08) 0%, 
